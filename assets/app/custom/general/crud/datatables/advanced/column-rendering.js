			...
			columnDefs: [
				...
				},
				{
					...
					render: function(data, type, full, meta) {
						...
						return '<span class="kt-badge ' + status[data].class + ' kt-badge--inline kt-badge--pill" style="padding: 1.75rem 3.75rem;font-size: 16px;font-weight: 800;">' + status[data].title + '</span>';
					},
				},
				{
					targets: 5,
