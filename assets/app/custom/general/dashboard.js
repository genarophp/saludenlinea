...
var KTDashboard = function() {
    ...
    var salesStats = function() {
        ...
        var config = {
            type: 'line',
            data: {
                labels: ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "November", "December",
    ...
    var activitiesChart = function() {
        ...
        var gradient = ctx.createLinearGradient(0, 0, 0, 240);
        gradient.addColorStop(0, Chart.helpers.color('#BCEFEA').alpha(1).rgbString());
        gradient.addColorStop(1, Chart.helpers.color('#BCEFEA').alpha(0.3).rgbString());
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    label: "# Peticiones",
                    backgroundColor: Chart.helpers.color('#BCEFEA').alpha(1).rgbString(),  //gradient
                    borderColor: '#e13a58',
