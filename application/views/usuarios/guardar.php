...
<form method="post" action="<?php echo site_url('validadordeservicios/guardar_post/') ?><?php echo $id ?>">
   ...
   <div class="row">
      ...
      <div class="row">
         ...
         <a class="btn btn-danger" href="<?php echo base_url() ?>index.php/validadordeservicios/ver_usuario"> Cancelar </a>
      </div>
</form>
