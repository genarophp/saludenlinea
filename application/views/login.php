...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Comfenalco Valle Eps | Login</title>
		<meta name="description" content="Login Comfenalco Eps">
		...
		<link href="<?php echo base_url(); ?>assets/app/custom/login/login-v1.default.css" rel="stylesheet" type="text/css" />
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
					...
					<div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url(<?php echo base_url(); ?>assets/media//bg/bg-4.jpg);">
						<div class="kt-grid__item">
							<a class="kt-login__logo">
								<img src="<?php echo base_url(); ?>assets/media/logos/logo-2021-small.png">
							</a>
						</div>
						<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
							<div class="kt-grid__item kt-grid__item--middle">
								<h3 class="kt-login__title">¡Bienvenido a Salud En Linea!</h3>
								<h4 class="kt-login__subtitle">Portal transaccional de Comfenalco Valle EPS.</h4>
							</div>
						</div>
						<div class="kt-grid__item">
							<div class="kt-login__info">
								<div class="kt-login__copyright">
									&copy 2021 Comfenalco Valle EPS
								</div>
								<div class="kt-login__menu">
									<a href="https://www.comfenalcovalle.com.co/salud/" target="_blank" class="kt-link">Ir a portal EPS.</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
						...
						<!-- <div class="kt-login__head">
							<span class="kt-login__signup-label">¿Aún no tienes una cuenta?</span>&nbsp;&nbsp;
						...
						<div class="kt-login__body">
							...
							<div class="kt-login__form">
								...
								<!--begin::Form-->
								<form id="formLogin" class="kt-form" action="" novalidate="novalidate">
									<div class="form-group">
										<input class="form-control" type="text" placeholder="Identificación o Correo" name="email" autocomplete="off">
									</div>
									<div class="form-group">
									...
									<div class="kt-login__actions">
										...
										<button type="submit" class="btn btn-primary btn-elevate kt-login__btn-primary">Iniciar</button>
									</div>
		...
		<script src="<?php echo base_url(); ?>assets/app/custom/login/login-v1.js" type="text/javascript"></script>
